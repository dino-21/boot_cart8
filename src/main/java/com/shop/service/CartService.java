...
public class CartService {
    private final ItemRepository itemRepository;  // 상품 DB
    private final MemberRepository memberRepository; // 회원 DB
    private final CartRepository cartRepository; // 장바구니 DB
    private final CartItemRepository cartItemRepository; // 장바구니 항목 DB
